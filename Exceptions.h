...
private:
	T elementoRepetido;
public:
	explicit ElementAlreadyExistsException(T elemento_repetido, const char* pStr = "Element already exists!") :
...
public:
	explicit ElementDoesntExistsException(T elementoInexistente, const char* pStr = "Element does not exist!") :
...
public:
	explicit EmptyContainerException(const char* pStr = "The container you are trying to access is empty!") : Exceptions(pStr) {}
...
public:
	explicit CorruptedFileException(const char* pStr = "File with data corrupted!") : Exceptions(pStr) {}
	string getFilename() const { return filename; }
...
public:
	explicit ExOutOfRange(const char* pStr = "Value outside the vector domain!") : Exceptions(pStr) {}
...
public:
	explicit ExNoInterval(const char* pStr = "The break begins and ends at zero!") : Exceptions(pStr) {}
